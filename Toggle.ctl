...
Private mFont As Font, mForeColor As OLE_COLOR, mBackColor As OLE_COLOR, mIconPath As String, mIconRatio As Single, mSelected As Boolean
...
Public Property Let Selected(Value As Boolean)
    If Value = True Then
        ...
        For Each Ctl In UserControl.Parent
            If TypeName(Ctl) = "Toggle" Then Ctl.Selected = False
        Next
    End If
    mSelected = Value
